...
const images = movie.poster_path ?`https://image.tmdb.org/t/p/original${movie.poster_path}`:backup; 
  ...
  useEffect(() => {
      async function fetchMovies() {
          try {
              ...
              setMovie(jsonData);  // Check if results exist
    ...
    <main className="container">
      ...
      <div className="row">
        <div className="col-md-4">
          <img src={images} className="img-fluid img-thumbnail" />
        </div>
